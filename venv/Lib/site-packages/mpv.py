...
def identity_decoder(b): return b
def strict_decoder(b): return b.decode('utf-8')
    ...
    def node_cast_value(v, fmt=MpvFormat.NODE, decoder=identity_decoder):
        if fmt == MpvFormat.NONE:
            ...
            if fmt == MpvFormat.NODE:
                ...
                raise TypeError(
                    'Unknown MPV node format {}. Please submit a bug report.'.format(fmt))
    ...
    if deprecated:
        ...
        def wrapper(*args, **kwargs):
            if not wrapper.warned:  # Only warn on first invocation to prevent spamming
                warn("Backend C api has been deprecated: " +
...
def _handle_gl_func(name, args=[], restype=None, deprecated=False):
    _handle_func(name, args, restype, errcheck=None,
                 ctx=MpvOpenGLCbContext, deprecated=deprecated)
...
_handle_func('mpv_create_client',           [
             c_char_p],                                 MpvHandle, notnull_errcheck)
...
_handle_func('mpv_terminate_destroy',       [],
             None, errcheck=None)
_handle_func('mpv_load_config_file',        [
             c_char_p],                                 c_int, ec_errcheck)
_handle_func('mpv_get_time_us',             [],
             c_ulonglong, errcheck=None)

_handle_func('mpv_set_option',              [
             c_char_p, MpvFormat, c_void_p],            c_int, ec_errcheck)
_handle_func('mpv_set_option_string',       [
             c_char_p, c_char_p],                       c_int, ec_errcheck)

_handle_func('mpv_command',                 [POINTER(
    c_char_p)],                        c_int, ec_errcheck)
_handle_func('mpv_command_string',          [
             c_char_p, c_char_p],                       c_int, ec_errcheck)
_handle_func('mpv_command_async',           [
             c_ulonglong, POINTER(c_char_p)],           c_int, ec_errcheck)
_handle_func('mpv_command_node',            [POINTER(
    MpvNode), POINTER(MpvNode)],       c_int, ec_errcheck)
_handle_func('mpv_command_async',           [
             c_ulonglong, POINTER(MpvNode)],            c_int, ec_errcheck)

_handle_func('mpv_set_property',            [
             c_char_p, MpvFormat, c_void_p],            c_int, ec_errcheck)
_handle_func('mpv_set_property_string',     [
             c_char_p, c_char_p],                       c_int, ec_errcheck)
_handle_func('mpv_set_property_async',      [
             c_ulonglong, c_char_p, MpvFormat, c_void_p], c_int, ec_errcheck)
_handle_func('mpv_get_property',            [
             c_char_p, MpvFormat, c_void_p],            c_int, ec_errcheck)
_handle_func('mpv_get_property_string',     [
             c_char_p],                                 c_void_p, bytes_free_errcheck)
_handle_func('mpv_get_property_osd_string', [
             c_char_p],                                 c_void_p, bytes_free_errcheck)
_handle_func('mpv_get_property_async',      [
             c_ulonglong, c_char_p, MpvFormat],         c_int, ec_errcheck)
_handle_func('mpv_observe_property',        [
             c_ulonglong, c_char_p, MpvFormat],         c_int, ec_errcheck)
_handle_func('mpv_unobserve_property',      [
             c_ulonglong],                              c_int, ec_errcheck)

_handle_func('mpv_event_name',              [
             c_int],                                    c_char_p, errcheck=None, ctx=None)
_handle_func('mpv_error_string',            [
             c_int],                                    c_char_p, errcheck=None, ctx=None)

_handle_func('mpv_request_event',           [
             MpvEventID, c_int],                        c_int, ec_errcheck)
_handle_func('mpv_request_log_messages',    [
             c_char_p],                                 c_int, ec_errcheck)
_handle_func('mpv_wait_event',              [
             c_double],                                 POINTER(MpvEvent), errcheck=None)
_handle_func('mpv_wakeup',                  [],
             None, errcheck=None)
_handle_func('mpv_set_wakeup_callback',     [
             WakeupCallback, c_void_p],                 None, errcheck=None)
_handle_func('mpv_get_wakeup_pipe',         [],
             c_int, errcheck=None)

_handle_func('mpv_stream_cb_add_ro',        [
             c_char_p, c_void_p, StreamOpenFn],         c_int, ec_errcheck)

_handle_func('mpv_render_context_create',               [
             MpvRenderCtxHandle, MpvHandle, POINTER(MpvRenderParam)],   c_int, ec_errcheck,     ctx=None)
_handle_func('mpv_render_context_set_parameter',        [
             MpvRenderParam],                                           c_int, ec_errcheck,     ctx=MpvRenderCtxHandle)
_handle_func('mpv_render_context_get_info',             [
             MpvRenderParam],                                           c_int, ec_errcheck,     ctx=MpvRenderCtxHandle)
_handle_func('mpv_render_context_set_update_callback',  [
             RenderUpdateFn, c_void_p],                                 None, errcheck=None,    ctx=MpvRenderCtxHandle)
_handle_func('mpv_render_context_update',               [],
             c_int64, errcheck=None, ctx=MpvRenderCtxHandle)
_handle_func('mpv_render_context_render',               [POINTER(
    MpvRenderParam)],                                  c_int, ec_errcheck,     ctx=MpvRenderCtxHandle)
_handle_func('mpv_render_context_report_swap',          [],
             None, errcheck=None,    ctx=MpvRenderCtxHandle)
...
if hasattr(backend, 'mpv_get_sub_api'):
    _handle_func('mpv_get_sub_api',             [
                 MpvSubApi],                                c_void_p, notnull_errcheck, deprecated=True)

    _handle_gl_func('mpv_opengl_cb_set_update_callback',    [
                    OpenGlCbUpdateFn, c_void_p], deprecated=True)
    _handle_gl_func('mpv_opengl_cb_init_gl',                [
                    c_char_p, OpenGlCbGetProcAddrFn, c_void_p],    c_int, deprecated=True)
    _handle_gl_func('mpv_opengl_cb_draw',                   [
                    c_int, c_int, c_int],                          c_int, deprecated=True)
    _handle_gl_func('mpv_opengl_cb_render',                 [
                    c_int, c_int],                                 c_int, deprecated=True)
    _handle_gl_func('mpv_opengl_cb_report_flip',            [
                    c_ulonglong],                                  c_int, deprecated=True)
...
def _mpv_coax_proptype(value, proptype=str):
    ...
    if type(value) is bytes:
        ...
        raise TypeError('Cannot coax value of type {} into property type {}'.format(
            type(value), proptype))
...
def _py_to_mpv(name): return name.replace('_', '-')
def _mpv_to_py(name): return name.replace('-', '_')
...
class ImageOverlay:
    ...
    def update(self, img=None, pos=None):
        ...
        self.m.overlay_add(self.overlay_id, x, y, source,
                           0, 'bgra', w, h, stride)
...
class FileOverlay:
    ...
    def update(self, filename=None, size=None, stride=None, pos=None):
        ...
        self.m.overlay_add(self, self.overlay_id, x, y,
                           self.filename, 0, 'bgra', w, h, stride)
...
class MPV(object):
    ...
    def __init__(self, *extra_mpv_flags, log_handler=None, start_event_thread=True, loglevel=None, **extra_mpv_opts):
        ...
        _mpv_set_option_string(
            self.handle, b'vid', b'no')
        def istr(o): return ('yes' if o else 'no') if type(
            o) is bool else str(o)
        try:
            ...
            for k, v in extra_mpv_opts.items():
                _mpv_set_option_string(self.handle, k.replace(
                    '_', '-').encode('utf-8'), istr(v).encode('utf-8'))
        ...
        self._event_handle = _mpv_create_client(
            self.handle, b'py_event_handler')
    ...
    def screenshot_raw(self, includes='subtitles'):
        ...
        if res['format'] != 'bgr0':
            raise ValueError('Screenshot in unknown format "{}". Currently, only bgr0 is supported.'
                             .format(res['format']))
        img = Image.frombytes(
            'RGBA', (res['stride']//4, res['h']), res['data'])
        b, g, r, a = img.split()
    ...
    def loadfile(self, filename, mode='replace', **options):
        ...
        self.command('loadfile', filename.encode(fs_enc),
                     mode, MPV._encode_options(options))
    ...
    def audio_add(self, url, flags='select', title=None, lang=None):
        ...
        self.command('audio_add', url.encode(fs_enc),
                     *_drop_nones(flags, title, lang))
    ...
    def video_add(self, url, flags='select', title=None, lang=None):
        ...
        self.command('video_add', url.encode(fs_enc),
                     *_drop_nones(flags, title, lang))
    ...
    def sub_add(self, url, flags='select', title=None, lang=None):
        ...
        self.command('sub_add', url.encode(fs_enc),
                     *_drop_nones(flags, title, lang))
    ...
    def overlay_add(self, overlay_id, x, y, file_or_fd, offset, fmt, w, h, stride):
        ...
        self.command('overlay_add', overlay_id, x, y,
                     file_or_fd, offset, fmt, w, h, stride)
    ...
    def observe_property(self, name, handler):
        ...
        _mpv_observe_property(self._event_handle, hash(
            name) & 0xffffffffffffffff, name.encode('utf-8'), MpvFormat.NODE)
    ...
    def event_callback(self, *event_types):
        ...
        def register(callback):
            with self._event_handler_lock:
                self.check_core_alive()
                types = [MpvEventID.from_str(t) if isinstance(
                    t, str) else t for t in event_types] or MpvEventID.ANY
    ...
    def key_binding(self, keydef, mode='force'):
        ...
        """
        def register(fun):
            fun.mpv_key_bindings = getattr(
                fun, 'mpv_key_bindings', []) + [keydef]
    ...
    def register_stream_protocol(self, proto, open_fn=None):
        ...
        def decorator(open_fn):
            ...
            def open_backend(_userdata, uri, cb_info):
                ...
                frontend._registered_callbacks = [
                    read, close, seek, size, cancel]
        ...
        def register(cb):
            ...
            def unregister():
                if name not in self._python_streams or\
                    ...
                    raise RuntimeError(
                        'Python stream has already been unregistered')
    ...
    def _set_property(self, name, value):
        ...
        if isinstance(value, (list, set, dict)):
            ...
            _mpv_set_property_string(
                self.handle, ename, _mpv_coax_proptype(value))
...
class MpvRenderContext:
    ...
    def render(self, **kwargs):
        _mpv_render_context_render(
            self._handle, kwargs_to_render_param_array(kwargs))
